...
def run_cleaning_and_qc(input_path: str) -> tuple[pd.DataFrame, pd.DataFrame, dict, Path]:
    """
    Read raw laboratory data, clean it, apply QC rules,
    build QC alerts, summarize QC results, and save outputs
    ...
    return df, alerts_df, summary, run_dir


if __name__ == "__main__":
    result_df, alerts_df, summary, run_dir = run_cleaning_and_qc("data/raw/lab_measurements.csv")
